...
//    }    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View inflate = inflater.inflate(R.layout.main, null);
//        setContentView(R.layout.main);
        ...
        Button picBtn = (Button) inflate.findViewById(R.id.button1);
        picBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                bundl.putString("path", mCurrentPhotoPath);

                tabFragment.setArguments(bundl);
...
//        );
        ...
        Button picSBtn = (Button) inflate.findViewById(R.id.button2);
        setBtnListenerOrDisable(
                picSBtn,
...
//		);
    ...
    private void setBtnListenerOrDisable(
        ...
        if (isIntentAvailable(this.getActivity(), intentName)) {
