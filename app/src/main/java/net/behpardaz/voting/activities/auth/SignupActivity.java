...
public class SignupActivity extends AppCompatActivity {
    ...
    public void signup() {
        ...
        progressDialog.setMessage("ثبت همیار جدید . . .");
        progressDialog.show();
    ...
    public void onSignupSuccess() {
        ...
        manager.setPreferences(SignupActivity.this, "status", "1");


        String status=manager.getPreferences(SignupActivity.this,"status");
        Log.d("status", status);
