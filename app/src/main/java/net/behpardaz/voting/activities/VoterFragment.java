...
//            galleryAddPic();
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putParcelableArrayList(STATE_LIST, customImageAdapter.getList());
    }
...
//    }    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View inflate = inflater.inflate(R.layout.updates_layout,null);
...
//        if(getSets.isEmpty())
        ...
        customImageAdapter = new CustomImageAdapter(getSets, this);
